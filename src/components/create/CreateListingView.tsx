  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-10">
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-14 h-14 bg-teal/15 rounded-2xl mb-3">
          <Home size={28} className="text-teal" />
        </div>
        <h1 className="text-2xl font-bold text-dark">List Your Place</h1>
      ...
      {success ? (
        <div className="bg-white rounded-xl p-8 text-center shadow-sm border border-mint animate-fade-in-up">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-mint">
